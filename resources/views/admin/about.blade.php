              		...
              		<div class="card">
	              		...
	              		<div class="card-body">
	              			<div class="row">
		                        ...
		                        <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="summernote">{{ $about->content }}</textarea>
		                      </div>
	              				</div>
	              				<div class="col-md-4">
	              					<label for="thumbnail">Thumbnail</label>
											    ...
											    <img src="{{ asset('') }}{{ $about->thumbnail }}" style="width:100%;height: 255px;" id="preview" class="img-thumbnail">
												</div>
