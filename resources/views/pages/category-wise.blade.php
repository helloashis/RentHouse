            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumbs">
                        ...
                        <span class="last-item">Category Wise</span>
                        <span class="separator">&gt;</span>
                        <span class="last-item">{{ $category->title }} ({{ $row }}) </span>
                    </div>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
                                                    ...
                                                    <div class="text-content">
                                                        <div class="top-content">
                                                            ...
                                                            <span>
                                                                ...
                                                                {{ $item->address }}, {{ $item->getcity->name }}, {{ $item->getdist->name }}
                                                            </span>
